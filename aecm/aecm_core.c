...
int WebRtcAecm_CreateCore(AecmCore_t **aecmInst)
{
    ...
    *aecmInst = aecm;
    ...
    aecm->farFrameBuf = aWebRtc_CreateBuffer(FRAME_LEN + PART_LEN,
                                            sizeof(int16_t));
    if (!aecm->farFrameBuf)
    {
    ...
    aecm->nearNoisyFrameBuf = bWebRtc_CreateBuffer(FRAME_LEN + PART_LEN,
                                                  sizeof(int16_t));
    ...
    aecm->nearCleanFrameBuf = cWebRtc_CreateBuffer(FRAME_LEN + PART_LEN,
                                                  sizeof(int16_t));
    ...
    aecm->outFrameBuf = dWebRtc_CreateBuffer(FRAME_LEN + PART_LEN,
                                            sizeof(int16_t));
    if (!aecm->outFrameBuf)
    {
        WebRtcAecm_FreeCore(aecm);
